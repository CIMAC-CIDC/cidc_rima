...
rule ss_bcr_process:
    ...
    shell:
      "{params.path}; Rscript cidc_rima/src/immune_repertoire/trust4_bcr_process.R --cdr3 {input.report} --sampleid {params.sampleid} --stat {input.stat} --outdir {params.out_dir} "
...
rule ss_tcr_process:
    ...
    conda: "../envs/stat_perl_r.yml"
    shell:
      "{params.path}; Rscript cidc_rima/src/immune_repertoire/trust4_tcr_process.R --cdr3 {input.report} --sampleid {params.sampleid} --stat {input.stat} --outdir {params.out_dir} "
