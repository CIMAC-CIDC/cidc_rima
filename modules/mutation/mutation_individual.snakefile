...
fq_pair = "--right_fq " if len(config["samples"][metadata.index[0]]) == 2 else ""
...
rule STAR_fusion:
    ...
    output:
        ...
        # "analysis/star/{sample}/{sample}.Chimeric.out.junction" #just to make sure STAR output is available before STAR_Fusion
